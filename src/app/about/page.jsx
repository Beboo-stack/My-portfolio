        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            <span className="italic">
              “From concept to completion, I approach each project with a
              passion for storytelling and a commitment to creating work that
          ...
          <div
            className="flex flex-col gap-12 justify-center pb-48 mb-7"
            ref={experienceRef}
          >
            {/* EXPERIENCE TITLE */}
            <motion.h1
